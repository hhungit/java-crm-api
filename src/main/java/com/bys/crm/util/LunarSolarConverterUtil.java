...
public class LunarSolarConverterUtil {
	...
	public static String lunarYearToGanZhi(int lunarYear) {
		final String[] tianGan = { "Canh", "Tân", "Nhâm", "Quý", "Giáp", "Ất", "Bính", "Đinh", "Mậu", "Kỷ" };
		final String[] diZhi = { "Thân", "Dậu", "Tuất", "Hợi", "Tý", "Sửu", "Dần", "Mẹo", "Thìn", "Tỵ", "Ngọ", "Mùi" };
		return "Năm " + tianGan[(lunarYear) % 10] + " " + diZhi[(lunarYear) % 12];
	}
